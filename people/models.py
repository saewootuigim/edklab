...
class Person(models.Model):
    # priority
    priority = models.PositiveIntegerField(choices=((1,"supervisor"),(2,"postdoc"),(3,"visiting scholar"),(4,"grad student"),(5,"research technician"),(6,"undergrad")), null=True, blank=True)
    # personal info
